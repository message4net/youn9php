...
insert  into `domain_category`(`id`,`name`) values (1,'游戏wap2.0网站'),(2,'旧客服、管理系统'),(3,'绝色霸业wap网站'),(4,'(旧)绝色霸业充值平台回调地址'),(5,'网站编辑器'),(6,'git'),(7,'绝色霸业登陆服'),(8,'公司邮箱'),(9,'梦幻登录服'),(10,'魔力登录服'),(11,'侠义、梦幻三方充值回调'),(12,'wap1.0引导'),(13,'公司微信'),(14,'公司网站'),(15,'微信小游戏'),(16,'星球登陆服(停)'),(17,'侠义登录服'),(18,'充值支付页面'),(19,'角色霸业微信'),(20,'微信测试服'),(21,'程序调试'),(22,'绝色霸业充值回调(无法使用80端口)'),(23,'腾讯绝色霸业登陆服'),(24,'绝色霸业腾讯充值(request)回调地址(不能使用80端口)'),(25,'侠义第三方充值回调接口(xycentergate)'),(26,'侠义苹果登录域名(xycenterappstore,xycenterapp)'),(27,'江山争霸登录服'),(28,'游戏服1'),(29,'游戏服2'),(30,'游戏服3'),(31,'游戏服4'),(32,'游戏服5'),(33,'激活码兑换，UC礼包接入'),(34,'邮件');
...
insert  into `menu`(`id`,`name`,`parent_id`,`modelname`,`flag_set`) values (1,'系统管理',0,NULL,0),(3,'服务管理',9,'service',0),(2,'服务器管理',9,'server',0),(4,'权限管理',1,'role',0),(5,'用户管理',1,'user',0),(6,'个人管理',0,NULL,0),(7,'修改密码',6,'umdpswd',1),(8,'字段设置',6,'usetcol',1),(9,'运维管理',0,NULL,0),(10,'域名管理',9,'domain',0),(11,'域名分类',9,'domain_category',0);
