...
insert  into `role`(`id`,`name`,`creator`) values (1,'admin',1),(2,'init',1),(121,'初始权限',9),(9,'全部权限',1),(10,'默认权限',1),(99,'测试全部',1),(119,'全部权限',9),(120,'测试权限',9),(129,'tall',1),(133,'t0',1),(134,'t1',1),(135,'t2',1),(136,'ta',1);
