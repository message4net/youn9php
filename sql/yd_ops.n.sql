...
insert  into `service`(`id`,`name`,`server_id`,`game_id`,`service_category_id`,`db_service_id`,`ssh_service_id`,`dir_init`,`servernum`,`nickname`,`port_dbslave`,`port_dbmaster`,`port_sshout`,`port_sshin`,`port_socket`,`port_http`,`port_service`,`port_mem`,`appname`,`db_server_id`,`slave_server_id`,`mem_max`,`mem_min`,`mem_init`,`process`,`domain_category_id`) values (2,'网站编辑器',3,NULL,NULL,NULL,NULL,'/data/local/tomcat_edit3gsiteweb/','','',0,3297,4343,22,0,8005,9014,0,'edit3gsiteweb',3,3,'','','','bin/java -Djava.util.logging.config.file=/data/local/tomcat_edit3gsiteweb/conf/logging.properties',5),(4,'微信正式服',3,NULL,NULL,NULL,NULL,'/data/local/tomcat_weixin/','','',0,3297,4343,22,0,8045,9030,0,'weixin',3,3,'600','600','120','bin/java -Djava.util.logging.config.file=/data/local/tomcat_weixin/conf/logging.properties',13),(5,'ssh_60',3,NULL,NULL,NULL,NULL,'','','',0,0,0,0,4343,0,22,0,'',10,10,'','','','',16),(6,'ssh_253',2,NULL,NULL,NULL,NULL,'','','',0,0,0,0,4343,0,22,0,'',10,10,'','','','',16),(7,'ssh_67',1,NULL,NULL,NULL,NULL,'','','',0,0,0,0,22,0,22,0,'',10,10,'','','','',16),(8,'ssh_214',4,NULL,NULL,NULL,NULL,'','','',0,0,0,0,22,0,22,0,'',10,10,'','','','',16),(9,'mysql_54',8,NULL,NULL,NULL,NULL,'','','',0,0,0,0,3306,0,3306,0,'',8,9,'','','','',16),(10,'mysql_3297',3,NULL,NULL,NULL,NULL,'','','',0,0,0,0,3297,0,3297,0,'',3,3,'','','','',16);
...
insert  into `service_category`(`id`,`name`,`remark`) values (1,'mysql',''),(2,'ssh',''),(3,'业务',''),(4,'周边',''),(5,'web','');
