...
insert  into `game_category`(`id`,`name`,`remark`) values (1,'侠义',''),(2,'梦幻',''),(3,'魔力','');
...
insert  into `menu`(`id`,`name`,`parent_id`,`modelname`,`flag_set`,`type`,`flag_mod`) values (1,'系统管理',0,NULL,0,0,0),(3,'服务管理',9,'service',0,0,0),(2,'服务器管理',9,'server',0,0,0),(4,'权限管理',1,'role',0,0,1),(5,'用户管理',1,'user',0,0,2),(6,'个人管理',0,NULL,0,0,0),(7,'修改密码',6,'umdpswd',1,0,0),(8,'字段设置',6,'usetcol',1,0,0),(9,'运维管理',0,NULL,0,0,0),(10,'域名管理',9,'domain',0,0,0),(11,'域名分类',13,'domain_category',0,1,0),(12,'服务分类',13,'service_category',0,1,0),(13,'分类管理',9,'category',0,0,0),(14,'游戏分类',13,'game_category',0,1,0);
