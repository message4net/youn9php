...
insert  into `role_wordbook`(`role_id`,`wordbook_id`) values (1,1),(1,2),(1,3),(1,4),(1,5),(1,7),(1,8),(1,10),(1,11),(1,12),(1,13),(1,17),(1,18),(1,19),(1,20),(1,21),(1,22),(1,24),(1,25),(1,27),(1,29),(1,34),(1,35),(1,36),(1,37),(1,38),(1,39),(1,40),(1,41),(1,42),(1,43),(1,44),(1,45),(1,46),(1,47),(1,48),(1,49),(1,50),(1,51),(1,52),(1,53),(1,54),(9,1),(9,2),(9,3),(9,4),(9,5),(9,7),(9,8),(9,10),(9,11),(9,12),(9,13),(9,17),(9,18),(9,19),(9,20),(9,21),(9,22),(9,24),(9,25),(9,27),(9,29),(9,34),(9,35),(9,36),(9,37),(9,38),(9,39),(9,40),(9,41),(9,42),(9,43),(9,45),(9,46),(9,47),(9,48),(9,49),(9,50),(9,51),(9,52),(9,53),(9,54),(99,1),(99,2),(99,3),(99,4),(99,7),(99,8),(99,10),(99,11),(99,17),(99,18),(99,19),(99,20),(99,21),(99,24),(99,25),(99,27),(99,34),(119,1),(119,2),(119,3),(119,4),(119,5),(119,7),(119,8),(119,11),(119,12),(119,13),(119,17),(119,18),(119,19),(119,20),(119,21),(119,22),(119,24),(119,25),(119,29),(119,34),(119,35),(119,36),(119,37),(119,38),(119,39),(119,40),(119,41),(119,42),(119,43),(119,45),(119,46),(119,47),(119,48),(119,49),(119,50),(119,51),(119,52),(119,53),(119,54),(120,18),(120,19),(120,20),(120,21),(120,22),(120,24),(120,25),(120,29),(120,34),(120,35);
...
insert  into `server`(`id`,`name`,`ipi`,`ipo`,`port`,`cpu`,`hd`,`bandwidth`,`memory`,`enddate`) values (1,'主业务_67','10.105.73.234','115.159.53.67',NULL,'8c','8_30G','10M','16G','2018-12-13 17:43:00'),(2,'主业务_253','10.247.46.14','182.254.140.253',NULL,'8c','8_50G','10M','16G','2019-08-03 04:35:00'),(3,'跳板机_60','10.237.154.240','115.159.79.60',NULL,'4c','8_50G','3M','8G','2018-10-26 17:07:00'),(4,'业务_214','10.105.50.143','182.254.138.214',NULL,'4c','8_20G','3M','4G','2018-10-26 17:07:00'),(6,'测试服_251','192.168.2.251','',NULL,'8c','500G','','4G','0000-00-00 00:00:00'),(7,'网关_254','192.168.2.254','218.108.34.254',NULL,'8c','500G','','4G','0000-00-00 00:00:00'),(8,'主数据库_54','10.66.105.54','',3306,'','100G','','4G','2018-07-15 00:00:00');
...
insert  into `user_wordbook`(`user_id`,`wordbook_id`) values (1,1),(1,2),(1,3),(1,12),(1,18),(1,19),(1,20),(1,29),(1,35),(1,36),(1,37),(1,38),(1,39),(1,40),(1,41),(1,42),(1,43),(1,45),(1,54),(7,1),(7,2),(7,3),(7,18),(7,19),(7,20),(7,35);
...
insert  into `wordbook`(`id`,`type`,`flag`,`flag_mod`,`name`,`colnameid`,`keyid`,`seq`,`odr`,`menu_id`,`parent_id`,`flag_set`,`sql_col_str`,`sql_relate`,`sql_mod`,`sql_eval`) values (1,0,0,1,'序号','id',NULL,1,0,4,0,1,NULL,'',NULL,NULL),(2,0,0,0,'权限名称','name',NULL,2,1,4,0,0,NULL,'',NULL,NULL),(3,1,0,0,'权限明细','id','id',3,3,4,0,0,'id,name','select * from menu where parent_id>0','select * from role_menu where role_id=','\'select m.* from menu m,role_menu rm where m.id=rm.menu_id and role_id=\'.$para_sql_type_1.\' group by m.id\''),(4,2003,0,0,'新增','func_add',NULL,1,0,4,0,0,NULL,'',NULL,NULL),(5,2003,0,0,'批删除','oprt_delall',NULL,2,1,4,0,0,NULL,'',NULL,NULL),(7,1005,0,0,'编辑','func_mod_',NULL,1,0,4,0,0,NULL,'',NULL,NULL),(8,1005,1,0,'删除','oprt_del_',NULL,3,2,4,0,0,NULL,'',NULL,NULL),(37,0,0,0,'名称','name',NULL,1,1,2,0,0,NULL,NULL,NULL,NULL),(11,1005,0,0,'设置','func_set_',NULL,2,1,4,0,0,NULL,'',NULL,NULL),(12,6,0,1,'创建者','creator','creator',0,2,4,0,0,'id,name','',NULL,'\'select id,name from role where id in (\'.$para_sql_type_6.\')\''),(13,2003,0,0,'批换权','func_allset',NULL,4,3,4,0,0,NULL,'',NULL,NULL),(15,3000,0,0,'权限名称','name',NULL,0,NULL,4,17,0,NULL,'',NULL,NULL),(16,3001,0,0,'创建者','creator',NULL,0,NULL,4,17,0,NULL,'',NULL,NULL),(17,2999,0,0,'搜索',NULL,NULL,0,NULL,4,0,0,NULL,'',NULL,NULL),(18,0,0,1,'序号','id',NULL,1,0,5,0,1,NULL,'',NULL,NULL),(19,0,0,0,'用户名称','name',NULL,2,1,5,0,0,NULL,'',NULL,NULL),(21,2003,0,0,'新增','func_add',NULL,1,0,5,0,0,NULL,'',NULL,NULL),(22,2003,0,0,'批删除','oprt_delall',NULL,2,1,5,0,0,NULL,'',NULL,NULL),(24,1005,0,0,'编辑','func_mod_',NULL,1,0,5,0,0,NULL,'',NULL,NULL),(25,1005,1,0,'删除','oprt_del_',NULL,3,2,5,0,0,NULL,'',NULL,NULL),(36,0,0,1,'序号','id',NULL,0,0,2,0,0,NULL,NULL,NULL,NULL),(29,6,0,1,'创建组','creator','creator',0,3,5,0,0,'id,name','',NULL,'\'select id,name from role where id in (\'.$para_sql_type_6.\')\''),(20,6,0,0,'所属组','role_id','id',2,4,5,0,0,'id,name','',NULL,'\'select id,name from role where id in (\'.$para_sql_type_6.\')\''),(32,3000,0,0,'用户名称','name',NULL,0,NULL,5,34,0,NULL,'',NULL,NULL),(33,3001,0,0,'创建者','creator',NULL,0,NULL,5,34,0,NULL,'',NULL,NULL),(34,2999,0,0,'搜索',NULL,NULL,0,NULL,5,0,0,NULL,'',NULL,NULL),(35,0,0,0,'密码','password',NULL,0,2,5,0,0,NULL,NULL,NULL,NULL),(38,0,0,0,'内网ip','ipi',NULL,2,2,2,0,0,NULL,NULL,NULL,NULL),(39,2,0,0,'外网ip','ipo',NULL,3,3,2,0,0,NULL,NULL,NULL,NULL),(40,0,0,0,'内存','memory',NULL,4,5,2,0,0,NULL,NULL,NULL,NULL),(41,2,0,0,'带宽','bandwidth',NULL,5,6,2,0,0,NULL,NULL,NULL,NULL),(42,2,0,0,'cpu','cpu',NULL,6,7,2,0,0,NULL,NULL,NULL,NULL),(43,0,0,0,'硬盘','hd',NULL,7,8,2,0,0,NULL,NULL,NULL,NULL),(45,2,0,0,'到期时间','enddate',NULL,9,10,2,0,0,NULL,NULL,NULL,NULL),(46,2003,0,0,'新增','func_add',NULL,1,0,2,0,0,NULL,NULL,NULL,NULL),(47,2003,0,0,'批删除','oprt_delall',NULL,2,1,2,0,0,NULL,NULL,NULL,NULL),(48,1005,0,0,'编辑','func_mod_',NULL,1,0,2,0,0,NULL,NULL,NULL,NULL),(49,1005,0,0,'删除','oprt_del_',NULL,3,2,2,0,0,NULL,NULL,NULL,NULL),(50,2003,0,0,'新增','func_add',NULL,1,0,3,0,0,NULL,NULL,NULL,NULL),(51,2003,0,0,'批删除','oprt_delall',NULL,2,1,3,0,0,NULL,NULL,NULL,NULL),(52,1005,0,0,'编辑','func_mod_',NULL,1,0,3,0,0,NULL,NULL,NULL,NULL),(53,1005,0,0,'删除','oprt_del_',NULL,3,2,3,0,0,NULL,NULL,NULL,NULL),(54,2,0,0,'端口','port',NULL,4,4,2,0,0,NULL,NULL,NULL,NULL);
