...
insert  into `wordbook`(`id`,`type`,`flag`,`name`,`colnameid`,`seq`,`odr`,`menu_sub_id`,`flag_set`,`sql_suffix`,`sql_postfix`) values (1,0,0,'序号','id',1,0,4,1,NULL,NULL),(2,0,0,'权限名称','name',2,1,4,0,NULL,NULL),(3,1,0,'权限明细',NULL,3,3,4,0,NULL,NULL),(4,2003,0,'新增','func_add',1,0,4,0,NULL,NULL),(5,2003,0,'批删除','func_delall',2,1,4,0,NULL,NULL),(7,1005,0,'编辑','func_mod_',1,0,4,0,NULL,NULL),(8,1005,1,'删除','func_del_',3,2,4,0,NULL,NULL),(10,2003,0,'字段设置','func_setcol',3,2,4,1,NULL,NULL),(11,1005,0,'设置','func_set_',2,1,4,0,NULL,NULL),(12,6,0,'创建者','creator',0,2,4,0,NULL,NULL),(13,2003,0,'批换权','func_setall',4,3,4,0,NULL,NULL);
