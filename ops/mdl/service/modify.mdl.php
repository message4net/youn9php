	...
	case 'add':
		...
		switch ($_POST['fr']){
			...
			case 'add':
				...
				$result_vrf=$db_modify->select($sql_vrf);
				if (!$result_vrf){
					$sql_m='insert into '.$table_mod.' (service_category_id,name,server_id,servernum,nickname,dir_init,port_dbslave,port_dbmaster,port_sshout,port_sshin,port_socket,port_http,port_service,port_mem,appname,mem_max,mem_min,mem_init,domain_category_id,process,db_server_id,slave_server_id) values (\''.$_POST['rc130'].'\',\''.$_POST['ra59'].'\',\''.$_POST['rc60'].'\',\''.$_POST['ra62'].'\',\''.$_POST['ra63'].'\',\''.$_POST['ra64'].'\',\''.$_POST['ra65'].'\',\''.$_POST['ra66'].'\',\''.$_POST['ra67'].'\',\''.$_POST['ra68'].'\',\''.$_POST['ra69'].'\',\''.$_POST['ra70'].'\',\''.$_POST['ra71'].'\',\''.$_POST['ra72'].'\',\''.$_POST['ra73'].'\',\''.$_POST['ra75'].'\',\''.$_POST['ra76'].'\',\''.$_POST['ra77'].'\',\''.$_POST['rc74'].'\',\''.$_POST['ra119'].'\',\''.$_POST['rc120'].'\',\''.$_POST['rc121'].'\')';
					$tips_tmp='新增';
					$flag_name=1;
				}else{
